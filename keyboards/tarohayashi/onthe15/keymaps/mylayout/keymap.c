...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [BASE] = LAYOUT(
      ...
      KC_LGUI, KC_A, KC_S, KC_D, KC_F, KC_G, KC_SPC,KC_SPC, KC_H, KC_J, KC_K, KC_L, KC_SCLN, KC_QUOT, KC_ENT,
      KC_LSFT, KC_Z, KC_X, KC_C, KC_V, KC_B, LT(LOWER, KC_LNG2), LT(LOWER, KC_LNG1),KC_N, KC_M, KC_COMM, KC_DOT,  KC_SLSH, KC_BSLS, RSFT_T(KC_F7),
